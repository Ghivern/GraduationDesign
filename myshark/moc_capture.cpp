...
QT_MOC_LITERAL(1, 8, 17), // "onePacketCaptured"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5), // "index"
QT_MOC_LITERAL(4, 33, 8), // "StartCap"
QT_MOC_LITERAL(5, 42, 7) // "StopCap"

    },
    "Capture\0onePacketCaptured\0\0index\0"
    "StartCap\0StopCap"
};
...
void Capture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onePacketCaptured((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 1: _t->StartCap(); break;
        case 2: _t->StopCap(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Capture::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Capture::onePacketCaptured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Capture::onePacketCaptured(qint64 _t1)
{
